        ...
        <section className="min-h-[100vh] flex items-center justify-center px-6 pt-24">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a 
                href="#packages" 
                className="inline-block px-8 py-3 bg-transparent border border-[#2A50DF] text-[#62D4F9] font-semibold rounded-full hover:bg-[#62D4F9] hover:text-black transition-all transform hover:scale-105 text-lg hover:shadow-[0_0_20px_#62D4F9]"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-black/50 backdrop-blur-xl border border-[#62D4F9]/30 rounded-2xl p-8 hover:border-[#62D4F9]/50 transition-all relative shadow-[0_0_30px_rgba(98,212,249,0.1)]">
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    <Check className="w-5 h-5 text-[#62D4F9] drop-shadow-[0_0_4px_#62D4F9]" />
                    <span className="text-white">You own the code, we retain the IP and the right to sell the bot</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="w-5 h-5 text-[#62D4F9] drop-shadow-[0_0_4px_#62D4F9]" />
              ...
              <div className="bg-black/50 backdrop-blur-xl border border-[#62D4F9]/30 rounded-2xl p-8 hover:border-[#62D4F9]/50 transition-all relative shadow-[0_0_30px_rgba(98,212,249,0.1)]">
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center gap-3">
                    <Check className="w-5 h-5 text-[#62D4F9] drop-shadow-[0_0_4px_#62D4F9]" />
                    <span className="text-white">You own the bot and website code, we retain the IP and the right to sell the bot</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Check className="w-5 h-5 text-[#62D4F9] drop-shadow-[0_0_4px_#62D4F9]" />
