        ...
        <section className="min-h-[100vh] flex items-center justify-center px-6 pt-24 md:pt-24">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link 
                href="/chat/demo" 
                className="px-8 py-3 border border-[#40FFD9] text-white font-semibold rounded-full hover:bg-[#40FFD9] hover:text-black hover:border-[#40FFD9] transition-all text-lg"
              >
