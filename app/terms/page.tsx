      ...
      <main className="pt-32 pb-0">
        ...
        <section className="px-6 lg:px-8 pb-20">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">1. Acceptance of Terms</h2>
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">2. Description of Services</h2>
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">3. Quotes, Scope, and Pricing</h2>
            <p className="text-ink-2 mb-4">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">4. Payment Terms</h2>
            <ul className="list-disc list-inside text-ink-2 mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">5. Term and Cancellation</h2>
            <p className="text-ink-2 mb-4">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">6. Your Responsibilities</h2>
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">7. Intellectual Property</h2>
            <p className="text-ink-2 mb-4">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">8. AI Disclaimer</h2>
            <p className="text-ink-2 mb-4">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">9. Limitation of Liability</h2>
            <p className="text-ink-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">10. No Guarantee of Results</h2>
            <p className="text-ink-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">11. Data and Privacy</h2>
            <p className="text-ink-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">12. Third-Party Services</h2>
            <p className="text-ink-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">13. Indemnification</h2>
            <p className="text-ink-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">14. Governing Law</h2>
            <p className="text-ink-2 mb-6">
              These Terms are governed by the laws of Queensland, Australia. Any disputes shall be resolved in the courts of Queensland.
            </p>

            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">15. Dispute Resolution</h2>
            <p className="text-ink-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">16. Severability</h2>
            <p className="text-ink-2 mb-6">
              If any provision of these Terms is found to be unenforceable, the remaining provisions shall remain in full effect.
            </p>

            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">17. Entire Agreement</h2>
            <p className="text-ink-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">18. Changes to Terms</h2>
            <p className="text-ink-2 mb-6">
            ...
            <h2 className="text-2xl font-bold text-ink-1 mt-8 mb-4">19. Contact Information</h2>
            <p className="text-ink-2 mb-6">
