      ...
      <main className="pt-32 pb-0">
        ...
        <section className="px-6 lg:px-8 pb-20">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">1. Acceptance of Terms</h2>
            <p className="text-dt-secondary mb-6">
              By accessing or using CoreSentia&apos;s services (the &ldquo;Services&rdquo;), you agree to be bound by these Terms of Service (&ldquo;Terms&rdquo;). If you do not agree to these Terms, you may not use the Services.
            </p>
            ...
            <p className="text-dt-secondary mb-6">
              CoreSentia acts as a &ldquo;front gate&rdquo; lead capture system. We do not provide quotes, payment processing, or full business management systems unless explicitly agreed in writing.
            </p>

            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">3. Service Packages and Pricing</h2>
            <p className="text-dt-secondary mb-4">
              <strong className="text-dt-primary">SMS Responder:</strong> $499 setup + $150/month (inc. GST)<br />
              <strong className="text-dt-primary">Professional Package:</strong> $2,500 setup + $250/month (inc. GST)
            </p>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">4. SMS Message Allowance</h2>
            <p className="text-dt-secondary mb-4">
              <strong className="text-dt-primary">Monthly Allowance:</strong> SMS Responder and Professional Package both include up to 500 SMS messages per month (incoming and outgoing combined).
            </p>
            <p className="text-dt-secondary mb-4">
              <strong className="text-dt-primary">Usage Monitoring:</strong> We will notify you via email when you approach 80% of your monthly allowance (400 messages).
            </p>
            <p className="text-dt-secondary mb-6">
              <strong className="text-dt-primary">Overage Charges:</strong> Messages exceeding the 500 monthly allowance are billed at $0.15 per SMS (inc. GST). Overage charges are invoiced at the end of each month.
            </p>

            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">5. Payment Terms</h2>
            <ul className="list-disc list-inside text-dt-secondary mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">6. Service Term and Cancellation</h2>
            <p className="text-dt-secondary mb-4">
              <strong className="text-dt-primary">No Lock-In:</strong> Services are provided month-to-month with no long-term contracts.
            </p>
            <p className="text-dt-secondary mb-4">
              <strong className="text-dt-primary">Cancellation:</strong> Either party may cancel with 30 days&apos; written notice. You will be charged for the remainder of your current billing period. Setup fees are non-refundable.
            </p>
            <p className="text-dt-secondary mb-6">
              <strong className="text-dt-primary">Service Suspension:</strong> We reserve the right to suspend services for non-payment, misuse, or violation of these Terms.
            </p>

            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">7. Your Responsibilities</h2>
            <p className="text-dt-secondary mb-4">You agree to:</p>
            <ul className="list-disc list-inside text-dt-secondary mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">8. AI Disclaimer</h2>
            <p className="text-dt-secondary mb-4">
              <strong className="text-dt-primary">AI Accuracy:</strong> While our AI is highly accurate, it may occasionally make errors or provide incorrect information. CoreSentia is not responsible for:
            </p>
            <ul className="list-disc list-inside text-dt-secondary mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">9. Limitation of Liability</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">10. No Guarantee of Results</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">11. Intellectual Property</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">12. Data and Privacy</h2>
            <p className="text-dt-secondary mb-6">
              Your use of the Services is also governed by our <Link href="/privacy" className="text-brand-accent hover:text-brand-highlight transition-colors">Privacy Policy</Link>, which explains how we collect, use, and protect your data and your customers&apos; data.
            </p>

            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">13. Service Modifications</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">14. Third-Party Services</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">15. Indemnification</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">16. Governing Law</h2>
            <p className="text-dt-secondary mb-6">
              These Terms are governed by the laws of Queensland, Australia. Any disputes shall be resolved in the courts of Queensland.
            </p>

            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">17. Dispute Resolution</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">18. Severability</h2>
            <p className="text-dt-secondary mb-6">
              If any provision of these Terms is found to be unenforceable, the remaining provisions shall remain in full effect.
            </p>

            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">19. Entire Agreement</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">20. Changes to Terms</h2>
            <p className="text-dt-secondary mb-6">
            ...
            <h2 className="text-2xl font-bold text-dt-primary mt-8 mb-4">21. Contact Information</h2>
            <p className="text-dt-secondary mb-6">
              For questions about these Terms, contact us at:<br />
              Email: <Link href="mailto:info@coresentia.com" className="text-brand-accent hover:text-brand-highlight transition-colors">info@coresentia.com</Link><br />
              ABN: 69 267 271 132
            </p>

            <div className="mt-12 pt-8 border-t border-dark-border">
              <p className="text-sm text-dt-tertiary">
                <strong className="text-dt-secondary">Acknowledgment:</strong> By using CoreSentia&apos;s services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
              </p>
            </div>
          </div>
        </section>
